...
export function LoginModal({ isOpen, onClose, redirectTo }: LoginModalProps) {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'telegram') => {
    setIsLoading(true);
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-3">
                  <button
                    ...
                    disabled={isLoading}
                    className="flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-white/10 disabled:opacity-50"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => handleOAuthSignIn('telegram')}
                    disabled={isLoading}
                    className="flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-white/10 disabled:opacity-50"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.161l-1.76 8.293c-.133.593-.482.74-.976.461l-2.7-1.988-1.301 1.252c-.144.144-.265.265-.543.265l.193-2.754 5.006-4.523c.218-.193-.047-.3-.338-.107l-6.188 3.898-2.664-.833c-.58-.181-.592-.58.121-.859l10.414-4.016c.482-.181.904.11.746.858z" />
                    </svg>
                    Telegram
                  </button>
                </div>
